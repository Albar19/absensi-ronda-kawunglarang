            ...
            <div className="flex items-start gap-4">
              ...
              <div className="min-w-0 flex-1">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1.5 mt-3 text-sm font-bold text-[#1e3a8a] hover:text-blue-700 transition-colors bg-white border border-slate-200 rounded-lg px-3 py-2"
                >
